...
#### <img src="https://avatars.githubusercontent.com/u/7756785?u=2893ea91743ac89ee3846d1f5c7209720e834129&v=4" width="50">[VoR0220](https://github.com/VoR0220) commented at [2016-12-30 17:38](https://github.com/ethereum/solidity/issues/1532#issuecomment-269799533):
...
#### <img src="https://avatars.githubusercontent.com/u/44281?u=19789513178700ad73a6cf535a40fbbfdc1ad615&v=4" width="50">[pirapira](https://github.com/pirapira) commented at [2016-12-30 17:53](https://github.com/ethereum/solidity/issues/1532#issuecomment-269801310):

In the context `a=`, the prefix `s` should be mapped to `s_1.4.6`.

#### <img src="https://avatars.githubusercontent.com/u/7756785?u=2893ea91743ac89ee3846d1f5c7209720e834129&v=4" width="50">[VoR0220](https://github.com/VoR0220) commented at [2016-12-30 20:36](https://github.com/ethereum/solidity/issues/1532#issuecomment-269819052):

okay, here's a better question: what is context `a=` in this instance? That would be a remapping under current definition?

#### <img src="https://avatars.githubusercontent.com/u/44281?u=19789513178700ad73a6cf535a40fbbfdc1ad615&v=4" width="50">[pirapira](https://github.com/pirapira) commented at [2016-12-30 20:55](https://github.com/ethereum/solidity/issues/1532#issuecomment-269820896):

`a=` is a directory.  I can create one like `mkdir a=`.

#### <img src="https://avatars.githubusercontent.com/u/7756785?u=2893ea91743ac89ee3846d1f5c7209720e834129&v=4" width="50">[VoR0220](https://github.com/VoR0220) commented at [2016-12-30 21:34](https://github.com/ethereum/solidity/issues/1532#issuecomment-269824624):

so what you're saying is that only the last `=` should be used to create a remapping in the full string, yes?

#### <img src="https://avatars.githubusercontent.com/u/44281?u=19789513178700ad73a6cf535a40fbbfdc1ad615&v=4" width="50">[pirapira](https://github.com/pirapira) commented at [2016-12-30 21:39](https://github.com/ethereum/solidity/issues/1532#issuecomment-269825185):

Maybe not, because the target can contain `=` too.  One way around is to introduce some escaping; `==` means a single `=`, perhaps.

#### <img src="https://avatars.githubusercontent.com/u/7756785?u=2893ea91743ac89ee3846d1f5c7209720e834129&v=4" width="50">[VoR0220](https://github.com/VoR0220) commented at [2016-12-30 22:48](https://github.com/ethereum/solidity/issues/1532#issuecomment-269831608):
...
#### <img src="https://avatars.githubusercontent.com/u/9073706?v=4" width="50">[chriseth](https://github.com/chriseth) commented at [2017-01-02 11:45](https://github.com/ethereum/solidity/issues/1532#issuecomment-269962367):
