# [\#2738 Issue](https://github.com/ethereum/solidity/issues/2738) `closed`: Normalize paths before using them for lookup key in Standard JSON
**Labels**: `medium effort`, `low impact`, `needs design`, `closed due inactivity`, `stale`


#### <img src="https://avatars.githubusercontent.com/u/886059?u=f80950ad1ba7341d064a5ccdf8eb5506c2ca96e8&v=4" width="50">[MicahZoltu](https://github.com/MicahZoltu) opened issue at [2017-08-13 17:54](https://github.com/ethereum/solidity/issues/2738):
...
#### <img src="https://avatars.githubusercontent.com/u/9073706?v=4" width="50">[chriseth](https://github.com/chriseth) commented at [2021-02-22 13:06](https://github.com/ethereum/solidity/issues/2738#issuecomment-783360330):
...
#### <img src="https://avatars.githubusercontent.com/u/886059?u=f80950ad1ba7341d064a5ccdf8eb5506c2ca96e8&v=4" width="50">[MicahZoltu](https://github.com/MicahZoltu) commented at [2021-02-24 10:35](https://github.com/ethereum/solidity/issues/2738#issuecomment-784979599):
...
#### <img src="https://avatars.githubusercontent.com/u/9073706?v=4" width="50">[chriseth](https://github.com/chriseth) commented at [2021-02-24 12:28](https://github.com/ethereum/solidity/issues/2738#issuecomment-785042110):

This sounds a lot like the `--base-path` option we already have.

#### <img src="https://avatars.githubusercontent.com/u/886059?u=f80950ad1ba7341d064a5ccdf8eb5506c2ca96e8&v=4" width="50">[MicahZoltu](https://github.com/MicahZoltu) commented at [2021-02-24 13:28](https://github.com/ethereum/solidity/issues/2738#issuecomment-785075504):

In that case just remove support for `./` and `../`.  😀  Again though, separate from this issue.  😉

#### <img src="https://avatars.githubusercontent.com/u/137030?v=4" width="50">[cameel](https://github.com/cameel) commented at [2021-03-03 17:32](https://github.com/ethereum/solidity/issues/2738#issuecomment-789912277):
...
#### <img src="https://avatars.githubusercontent.com/u/137030?v=4" width="50">[cameel](https://github.com/cameel) commented at [2021-03-03 17:35](https://github.com/ethereum/solidity/issues/2738#issuecomment-789916556):
...
#### <img src="https://avatars.githubusercontent.com/u/137030?v=4" width="50">[cameel](https://github.com/cameel) commented at [2021-03-03 19:00](https://github.com/ethereum/solidity/issues/2738#issuecomment-789978885):

> I think we should not silently normalize the paths. Instead we should not allow `.` or `..` as part of a filename in standard-json. In standard-json, the file paths are the identifiers used everywhere else and should not be silently changed.

Looks like we already have an issue for that: #5146.

#### <img src="https://avatars.githubusercontent.com/in/15368?v=4" width="50">[github-actions](https://github.com/apps/github-actions) commented at [2023-02-13 12:06](https://github.com/ethereum/solidity/issues/2738#issuecomment-1427830248):

This issue has been marked as stale due to inactivity for the last 90 days.
It will be automatically closed in 7 days.

#### <img src="https://avatars.githubusercontent.com/in/15368?v=4" width="50">[github-actions](https://github.com/apps/github-actions) commented at [2023-02-21 12:04](https://github.com/ethereum/solidity/issues/2738#issuecomment-1438364441):
