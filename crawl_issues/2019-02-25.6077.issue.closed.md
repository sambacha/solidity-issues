...
#### <img src="https://avatars.githubusercontent.com/u/20340?v=4" width="50">[axic](https://github.com/axic) commented at [2019-02-25 09:14](https://github.com/ethereum/solidity/issues/6077#issuecomment-466932619):

I think it should only dump the modified area with `...` prepended/appended if there is available memory before/after.

#### <img src="https://avatars.githubusercontent.com/u/9073706?v=4" width="50">[chriseth](https://github.com/chriseth) commented at [2019-02-25 10:41](https://github.com/ethereum/solidity/issues/6077#issuecomment-466963010):

I agree - there is a TODO in the code that asks for a "vector with holes" to be used for memory.

#### <img src="https://avatars.githubusercontent.com/u/9073706?v=4" width="50">[chriseth](https://github.com/chriseth) commented at [2019-02-25 10:48](https://github.com/ethereum/solidity/issues/6077#issuecomment-466965510):

If you think that the logging is the problem instead of just storing the memory, we could also just get rid of the dump.

#### <img src="https://avatars.githubusercontent.com/u/2388185?v=4" width="50">[bshastry](https://github.com/bshastry) commented at [2019-05-22 09:02](https://github.com/ethereum/solidity/issues/6077#issuecomment-494717961):

I think #6800 should fix this issue

#### <img src="https://avatars.githubusercontent.com/u/20340?v=4" width="50">[axic](https://github.com/axic) commented at [2020-04-05 23:04](https://github.com/ethereum/solidity/issues/6077#issuecomment-609499800):

@bshastry was this fixed?

#### <img src="https://avatars.githubusercontent.com/u/2388185?v=4" width="50">[bshastry](https://github.com/bshastry) commented at [2020-04-06 08:25](https://github.com/ethereum/solidity/issues/6077#issuecomment-609649924):
