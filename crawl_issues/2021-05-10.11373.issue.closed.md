# [\#11373 Issue](https://github.com/ethereum/solidity/issues/11373) `closed`: try/catch block does not catch the exception caused by EXTCODESIZE check on external calls
