# [\#12119 Issue](https://github.com/ethereum/solidity/issues/12119) `closed`: [CLI] Warn when a relative path specified on the CLI ends up being absolute in metadata
