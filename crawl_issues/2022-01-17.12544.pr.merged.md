# [\#12544 PR](https://github.com/ethereum/solidity/pull/12544) `merged`: Natspec: Fix ICE when overriding a struct getter with a Natspec-documented return value and the name in the struct is different.
