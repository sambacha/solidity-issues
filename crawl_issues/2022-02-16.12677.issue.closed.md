# [\#12677 Issue](https://github.com/ethereum/solidity/issues/12677) `closed`: Warn about not explicitly requested conversions from rational number types to their mobile type.
