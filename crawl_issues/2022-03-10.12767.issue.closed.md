# [\#12767 Issue](https://github.com/ethereum/solidity/issues/12767) `closed`: Private function names should not be checked for uniqueness when inherited by other contracts
